...
// init() line, the same as every other Kind. ARM CCA branched before the
// registry landed and carried its own copy; that copy is gone — there is one
// registry, one lookup (RegisteredVerifier), one dispatch path.
